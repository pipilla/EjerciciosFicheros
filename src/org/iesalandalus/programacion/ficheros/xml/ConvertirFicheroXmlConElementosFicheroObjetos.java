...
public class ConvertirFicheroXmlConElementosFicheroObjetos {
    private static final String FICHERO = String.format("%s%s%s", "ejemplos", File.separator, "personas_elementos.xml");
